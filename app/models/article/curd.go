...
func GetByCategoryID(cid string, r *http.Request, perPage int) ([]ArticlesData, pagination.ViewData, error) {

	// 1. 初始化分页实例
	db := model.DB.Model(ArticlesData{}).Where("category_id = ?", cid).Order("create_at desc")
